    ...
    <div>
        <div class="container">
            ...
            <el-table :data="tableData" size="mini" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                            ...
                            <el-table-column prop="collegeintro" label="备注"></el-table-column>
        ...
        <el-dialog title="添加" v-model="addVisible" width="45%">
            <el-form size="small" label-width="100px">
                                <el-form-item label="院系名:">
                                    <el-input placeholder="请输入院系名" v-model="form.collegename">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="备注:">
                                    <el-input placeholder="请输入备注" v-model="form.collegeintro">
                                    </el-input>
                                </el-form-item>
            </el-form>
            <template #footer>
