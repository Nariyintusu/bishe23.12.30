        ...
        <el-dialog title="添加" v-model="addVisible" width="45%">
            <el-form size="small" label-width="100px">
                ...
                <el-form-item label="性别:">
                    <el-input placeholder="请输入性别" v-model="form.sex">
                    </el-input>
                </el-form-item>
                ...
                <el-form-item label="登录密码:">
                    <el-input placeholder="请输入登录密码" v-model="form.password">
                    </el-input>
                </el-form-item>
                ...
                <el-form-item label="职称:">
                    <el-input placeholder="请输入职称" v-model="form.title">
                    </el-input>
                </el-form-item>
                <el-form-item label="职务:">
                    <el-input placeholder="请输入职务" v-model="form.job">
                    </el-input>
                </el-form-item>
                <el-form-item label="权限:">
                    <el-input placeholder="请输入权限" v-model="form.power">
                    </el-input>
                </el-form-item>
            </el-form>
            <template #footer>
        ...
        <el-dialog title="编辑" v-model="editVisible" width="45%">
            <el-form size="small" label-width="100px">
                <el-form-item label="工号:">
                    <el-input placeholder="请输入工号" :disabled="true" v-model="form.id">
                    </el-input>
                </el-form-item>
                <el-form-item label="姓名:">
                    <el-input placeholder="请输入姓名" v-model="form.name">
