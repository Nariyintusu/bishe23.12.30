        ...
        <el-row :gutter="20">
            <el-col :span="8">
                <el-card shadow="hover" class="mgb20" style="height:252px;">
                    <div class="user-info">
                        <img :src="loginAdmin.picurl" class="user-avator" alt/>
                        <div class="user-info-cont">
                            <div class="user-info-name">{{ loginAdmin.adminname }}</div>
                            <div>{{ loginAdmin.job }}</div>
                        </div>
                    </div>
                    <div class="user-info-list">
                        职   务：
                        <span>{{ loginAdmin.job }}</span>
                    </div>
                    <div class="user-info-list">
                        联系电话：
                        <span>{{ loginAdmin.phone }}</span>
                    </div>
                </el-card>
            ...
            <el-col :span="16">
                ...
                <el-card shadow="hover" style="height:403px;">
                    ...
                    <el-table :show-header="false" :data="tableData.noticeData" style="width:100%;">
