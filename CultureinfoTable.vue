    ...
    <div>
        <div class="container">
            ...
            <el-table :data="tableData" size="mini" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                                            <el-table-column prop="id" label="培养方案ID"></el-table-column>
                            <el-table-column prop="majorid" label="专业ID"></el-table-column>
                            <el-table-column prop="versions" label="版本"></el-table-column>
                            <el-table-column prop="matrixtable" label="支撑矩阵表"></el-table-column>
        ...
        <el-dialog title="添加" v-model="addVisible" width="45%">
            <el-form size="small" label-width="100px">
                                ...
                                <el-form-item label="版本:">
                                    <el-input placeholder="请输入版本" v-model="form.versions">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="支撑矩阵表:">
                                    <el-input placeholder="请输入支撑矩阵表" v-model="form.matrixtable">
                                    </el-input>
                                </el-form-item>
            </el-form>
            <template #footer>
        ...
        <el-dialog title="编辑" v-model="editVisible" width="45%">
            <el-form size="small" label-width="100px">
                        <el-form-item label="培养方案ID:">
                            <el-input placeholder="请输入培养方案ID" :disabled="true" v-model="form.id">
                            </el-input>
                        </el-form-item>
                                <el-form-item label="专业ID:">
                                    <el-input placeholder="请输入专业ID" v-model="form.majorid">
