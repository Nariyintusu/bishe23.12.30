    ...
    <div>
        <div class="container">
            ...
            <el-table :data="tableData" size="mini" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                                            <el-table-column prop="id" label="课表ID"></el-table-column>
                            <el-table-column prop="semester" label="学期"></el-table-column>
                            <el-table-column prop="coursenum" label="课号"></el-table-column>
        ...
        <el-dialog title="添加" v-model="addVisible" width="45%">
            <el-form size="small" label-width="100px">
                                <el-form-item label="学期:">
                                    <el-input placeholder="请输入学期" v-model="form.semester">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="课号:">
                                    <el-input placeholder="请输入课号" v-model="form.coursenum">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="教师工号:">
                                    <el-input placeholder="请输入教师工号" v-model="form.tid">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="班级ID:">
                                    <el-input placeholder="请输入班级ID" v-model="form.classid">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="时间:">
                                    <el-input placeholder="请输入时间" v-model="form.times">
                                    </el-input>
                                </el-form-item>
        ...
        <el-dialog title="编辑" v-model="editVisible" width="45%">
            <el-form size="small" label-width="100px">
                        <el-form-item label="课表ID:">
                            <el-input placeholder="请输入课表ID" :disabled="true" v-model="form.id">
                            </el-input>
                        </el-form-item>
                                <el-form-item label="学期:">
                                    <el-input placeholder="请输入学期" v-model="form.semester">
