    ...
    <div>
        <div class="container">
            ...
            <el-table :data="tableData" size="mini" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                            ...
                            <el-table-column prop="stuinfo" label="学生表"></el-table-column>
                            <el-table-column prop="versions" label="培养方案版本"></el-table-column>
        ...
        <el-dialog title="添加" v-model="addVisible" width="45%">
            <el-form size="small" label-width="100px">
                                <el-form-item label="年级:">
                                    <el-input placeholder="请输入年级" v-model="form.grade">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="专业名:">
                                    <el-input placeholder="请输入专业名" v-model="form.majorname">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="专业ID:">
                                    <el-input placeholder="请输入专业ID" v-model="form.majorid">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="人数:">
                                    <el-input placeholder="请输入人数" v-model="form.nums">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="学生表:">
                                    <el-input placeholder="请输入学生表" v-model="form.stuinfo">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="培养方案版本:">
                                    <el-input placeholder="请输入培养方案版本" v-model="form.versions">
                                    </el-input>
                                </el-form-item>
            </el-form>
            <template #footer>
        ...
        <el-dialog title="编辑" v-model="editVisible" width="45%">
            <el-form size="small" label-width="100px">
                        <el-form-item label="班级ID:">
                            <el-input placeholder="请输入班级ID" :disabled="true" v-model="form.id">
                            </el-input>
                        </el-form-item>
                                <el-form-item label="年级:">
                                    <el-input placeholder="请输入年级" v-model="form.grade">
