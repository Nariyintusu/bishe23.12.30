    ...
    <div>
        <div class="container">
            ...
            <el-table :data="tableData" size="mini" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                ...
                <el-table-column prop="outline" label="课程大钢"></el-table-column>
                <el-table-column prop="manageid" label="课程负责人工号"></el-table-column>
                <el-table-column prop="cid" label="所属院系ID"></el-table-column>
        ...
        <el-dialog title="添加" v-model="addVisible" width="45%">
            <el-form size="small" label-width="100px">
                <el-form-item label="课程编号:">
                    <el-input placeholder="请输入课程编号" v-model="form.id">
                    </el-input>
                </el-form-item>
                <el-form-item label="课程名:">
                    <el-input placeholder="请输入课程名" v-model="form.name">
                    </el-input>
                </el-form-item>
                <el-form-item label="学分:">
                    <el-input placeholder="请输入学分" v-model="form.score">
                    </el-input>
                </el-form-item>
                <el-form-item label="课程大钢:">
                    <el-input placeholder="请输入课程大钢" v-model="form.outline">
                    </el-input>
                </el-form-item>
                <el-form-item label="课程负责人工号:">
                    <el-input placeholder="请输入课程负责人工号" v-model="form.manageid">
                    </el-input>
                </el-form-item>
                <el-form-item label="所属院系ID:">
                    <el-input placeholder="请输入所属院系ID" v-model="form.cid">
                    </el-input>
                </el-form-item>
                <el-form-item label="学时:">
                    <el-input placeholder="请输入学时" v-model="form.classhour">
                    </el-input>
                </el-form-item>
            </el-form>
            <template #footer>
        ...
        <el-dialog title="编辑" v-model="editVisible" width="45%">
            <el-form size="small" label-width="100px">
                <el-form-item label="课程编号:">
                    <el-input placeholder="请输入课程编号" :disabled="true" v-model="form.id">
                    </el-input>
                </el-form-item>
                <el-form-item label="课程名:">
                    <el-input placeholder="请输入课程名" v-model="form.name">
